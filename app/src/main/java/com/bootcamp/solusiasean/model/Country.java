...
package com.bootcamp.solusiasean.model;
...
public class Country implements Serializable, Parcelable
{
    ...
    ;
    private final static long serialVersionUID = -8478379099821593911L;
    ...
    protected Country(Parcel in) {
        ...
        in.readList(this.currencies, (com.bootcamp.solusiasean.model.Currency.class.getClassLoader()));
        in.readList(this.languages, (com.bootcamp.solusiasean.model.Language.class.getClassLoader()));
        ...
        in.readList(this.regionalBlocs, (com.bootcamp.solusiasean.model.RegionalBloc.class.getClassLoader()));
